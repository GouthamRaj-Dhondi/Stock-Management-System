...
class Stock():
    ...
    def __init__(self, root):
        ...
        self.root=root
        self.root.title("S.M.S - For Kshatriya College Of Engineering")
        ...
        head_title = Label(self.root,text="Stock Management System",bd=5, relief=GROOVE, font=("ariel", 20 , "bold"), bg="blue", fg="white")
        ...
        Manage_Frame=Frame(self.root, bd=5, relief=RIDGE, bg="blue")
        Manage_Frame.place(x=10, y=80, width=350, height=570)

        m_title=Label(Manage_Frame,text="Manage Stock", font=("", 20 , "bold"), bg="blue", fg="white")
        ...
        lbl_product_id=Label(Manage_Frame,text="Product ID : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_product_id.grid(row=1, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_type=Label(Manage_Frame,text="Product Type : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_type.grid(row=2, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_model_no=Label(Manage_Frame,text="Model No : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_model_id.grid(row=3, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_manufacturer=Label(Manage_Frame,text="Manufacturer : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_manufacturer.grid(row=4, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_department=Label(Manage_Frame,text="Department : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        combo_department.grid(row=5, column=1, padx=5, pady=10,sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_location=Label(Manage_Frame,text="Location : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_location.grid(row=6, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_incharge=Label(Manage_Frame,text="Incharge : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        txt_incharge.grid(row=7, column=1, padx=5, pady=10, sticky ="w")

        #------------------------------------------------------------------------------------------------------------------------------------

        lbl_comment=Label(Manage_Frame,text="Comment : ", font=("", 12 , "bold"), bg="blue", fg="white")
        ...
        self.txt_comment.grid(row=8, column=1, padx=5, pady=10, sticky ="w")
        ...
        lbl_search=Label(Search_Frame,text="Search By : ", font=("", 13 , "bold"), bg="yellow", fg="black")
        ...
        search_button.grid(row=0, column=3, padx=4, pady=7)
